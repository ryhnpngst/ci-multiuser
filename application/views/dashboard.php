    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href=<?php echo base_url('home/index'); ?> class="navbar-brand mx-4 mb-3">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <span><?php echo $this->session->userdata('access'); ?></span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    <a href=<?php echo base_url('home/index'); ?> class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
